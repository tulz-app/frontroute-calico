package io.frontroute.site.icons
...
object Icons {
  ...
  //                     viewBox: String,
  //                     modifier: M
  //                   )(using Modifier[IO, E, M]): Resource[IO, fs2.dom.svg.[IO]] =
  //   svg(
  //     cls           := "fill-current",
