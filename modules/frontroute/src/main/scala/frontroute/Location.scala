...
final case class Location(
  ...
  state: Option[js.UndefOr[js.Any]],
...
object Location {
  ...
  def apply(location: dom.Location, state: Option[js.UndefOr[js.Any]]): Location = {
    ...
    new Location(
      ...
      host = location.host,
      origin = location.origin.asInstanceOf[js.UndefOr[String]].toOption,
      path = path,
      fullPath = path,
